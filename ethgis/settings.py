...
SECRET_KEY = os.getenv('SECRET_KEY', "204hp+q=kc$!#jitj1f7$9f@82)4z8o*r$tldwqvf)a!g*6)=y")
...
ROOT_URLCONF = os.getenv('ROOT_URLCONF','ethgis.urls')
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'ethgis Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, ethgis',
